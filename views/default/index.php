...
/* @var $searchModel yeesoft\product\models\search\ProductSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('yee/product', 'Products');
...
<div class="product-index">
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <?= Html::a(Yii::t('yee', 'Add New'), ['/product/default/create'], ['class' => 'btn btn-sm btn-primary']) ?>
            <?= Html::a(Yii::t('yee/media', 'Categories'), ['/product/category/index'], ['class' => 'btn btn-sm btn-primary']) ?>
        </div>
    </div>
        ...
        <div class="panel-body">
            ...
            <div class="row">
                ...
                <div class="col-sm-6 text-right">
                    <?= GridPageSize::widget(['pjaxId' => 'product-grid-pjax']) ?>
                </div>
            </div>

            <?php
            Pjax::begin([
                'id' => 'product-grid-pjax',
            ])
            ?>
            ...
            GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'title' => function (Product $model) {
                            return Html::a($model->title, ['/product/default/view', 'id' => $model->id], ['data-pjax' => 0]);
                        },
                    ],
                    [
                    ...
                    [
                        ...
                        'attribute' => 'status',
                        'optionsArray' => Product::getStatusOptionsList(),
